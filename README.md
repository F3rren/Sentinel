...
Modules planned for future iterations: XSS, IDOR/BOLA with multiple identities.
...
Every future attack module (XSS, IDOR/BOLA, ...) will follow the same `sentinel.scan.<module>.enabled` convention.
